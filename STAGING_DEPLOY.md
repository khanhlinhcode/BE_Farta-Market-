...
Until mail, an interactive Turnstile checkout, one hosted VNPay sandbox payment, funded AI inference, and credential rotation are complete, this is a staging/demo environment, not production-ready.
