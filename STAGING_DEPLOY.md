...
Until mail, an interactive Turnstile checkout, VNPay sandbox, AI, credential rotation, backup-after-sync, and end-to-end payment/order checks are complete, this is a staging/demo environment, not production-ready.
