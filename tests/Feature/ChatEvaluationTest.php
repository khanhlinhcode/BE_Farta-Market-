...
it('measures the local router and database retrieval baseline', function () {
    ...
    $definitions = [
        ['slug' => 'tra-nhe', 'name' => 'Trà Nhẹ', 'summary' => 'Đồ uống thanh nhẹ cho buổi sáng'],
        ['slug' => 'banh-yen-mach', 'name' => 'Bánh Yến Mạch', 'summary' => 'Món ăn nhẹ ít ngọt phù hợp mang đi làm'],
        ['slug' => 'nuoc-cam', 'name' => 'Nước Cam', 'summary' => 'Nước trái cây giàu vitamin vị cam'],
        ['slug' => 'ca-phe-den', 'name' => 'Cà Phê Đen', 'summary' => 'Cà phê đậm dùng vào buổi sáng'],
        ['slug' => 'banh-chocolate', 'name' => 'Bánh Chocolate', 'summary' => 'Bánh ngọt vị chocolate'],
    ];
    ...
    expect($metrics['intent_accuracy'])->toBeGreaterThanOrEqual(0.85)
        ->and($metrics['hit_rate_at_5'])->toBeGreaterThanOrEqual(0.8)
        ->and($metrics['mrr_at_5'])->toBeGreaterThanOrEqual(0.7)
