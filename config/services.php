...
return [
    ...
    */
    ...
    'ai_chat' => [
        ...
        'qdrant_collection' => env('QDRANT_COLLECTION', 'farta_chat_knowledge'),
        'qdrant_inference_enabled' => filter_var(env('QDRANT_INFERENCE_ENABLED', false), FILTER_VALIDATE_BOOL),
        'qdrant_inference_model' => env('QDRANT_INFERENCE_MODEL', 'intfloat/multilingual-e5-small'),
        'prompt_version' => env('AI_CHAT_PROMPT_VERSION', 'grounded-commerce-v3'),
